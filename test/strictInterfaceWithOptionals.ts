...
describe('strictInterfaceWithOptionals', () => {
  ...
  it('should fail validating an invalid value', () => {
    ...
    assertFailure(T.decode({ foo: 'foo', bar: 1 }), [
      'Invalid value 1 supplied to : T/1: PartialType<{ bar: string }>/bar: (string | undefined)/0: string',
      'Invalid value 1 supplied to : T/1: PartialType<{ bar: string }>/bar: (string | undefined)/1: undefined'
    ])
  })
